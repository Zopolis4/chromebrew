...
class Qt5_base < Package
  ...
  version 'kde-5.15.14-2b9835f'
  license 'GPL-2'
  compatibility 'x86_64 aarch64 armv7l'
  source_url 'https://invent.kde.org/qt/qt/qtbase.git'
  git_hashtag '2b9835f5c9bcfe3105b60a8dd33c1db7d8611378'
  binary_compression 'tar.zst'

  binary_sha256({
    aarch64: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
     armv7l: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
     x86_64: '8a84fdad57d266755cda54c362937d825db54381ad2c415ac438211b4dce083c'
  })
  ...
  depends_on 'mesa' # R
  depends_on 'mtdev' # R
  depends_on 'mysql' => :build if ARCH.eql?('x86_64')
  depends_on 'pango' # R
  depends_on 'pcre2' # R
